...
class Sql2oCandidateRepositoryTest {
    ...
    public void whenSaveThenGetSame() {
        ...
        var candidate = sql2oCandidateRepository.save(new Candidate(0, "title", "description", true, file.getId()));
    ...
    public void whenSaveSeveralThenGetAll() {
        var creationDate = now().truncatedTo(ChronoUnit.MINUTES);
        var candidate1 = sql2oCandidateRepository.save(new Candidate(0, "title1", "description1", true, file.getId()));
        var candidate2 = sql2oCandidateRepository.save(new Candidate(0, "title2", "description2", false, file.getId()));
        var candidate3 = sql2oCandidateRepository.save(new Candidate(0, "title3", "description3", true, file.getId()));
    ...
    public void whenUpdateThenGetUpdated() {
        ...
        var updatedCandidate = new Candidate(
                ...
                !candidate.getVisible(), file.getId()
        );
    ...
    public void whenUpdateUnExistingVacancyThenGetFalse() {
        var creationDate = now().truncatedTo(ChronoUnit.MINUTES);
        var candidate = new Candidate(0, "title", "description", true, file.getId());
